          ...
          >
            ...
            <div className="flex items-center gap-4 flex-wrap justify-center">
              ...
              <div className="relative">
                ...
                {isConnectMenuOpen && (
                  <div className="absolute right-0 mt-2 min-w-[200px] rounded-lg bg-black/20 backdrop-blur-sm border border-white/10">
                    <button
                      onClick={() => {
                        connectWallet();
                        setIsConnectMenuOpen(false);
                      }}
                      className="w-full px-4 py-2 text-left flex items-center space-x-2 hover:bg-white/5 rounded-t-lg"
                    >
                      <svg className="w-5 h-5 text-fuchsia-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
